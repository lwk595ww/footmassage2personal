package com.seetech.footmassage2.core.configration.seataConfig;/*
...
import com.seetech.footmassage2.core.configration.jacksonConfig.JacksonConfig;
 ...
 *
 *   SPI扩展seata自定义json解析器
 */
@LoadLevel(name = MySeataJacksonUndoLogParser.NAME)
public class MySeataJacksonUndoLogParser implements UndoLogParser, Initialize {

    public static final String NAME = "mySeataJackson";

    private static final Logger LOGGER = LoggerFactory.getLogger(MySeataJacksonUndoLogParser.class);

    private final ObjectMapper mapper = new ObjectMapper();
//    private final ObjectMapper mapper = SpringUtils.getBean("objectMapper",ObjectMapper.class);
...
//        System.out.println("xxx");
        ...
        javaTimeModule.addSerializer(LocalDateTime.class, new LocalDateTimeSerializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_DATE_TIME_FORMAT)));
        javaTimeModule.addSerializer(LocalDate.class, new LocalDateSerializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_DATE_FORMAT)));
        javaTimeModule.addSerializer(LocalTime.class, new LocalTimeSerializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_TIME_FORMAT)));
        javaTimeModule.addDeserializer(LocalDateTime.class, new LocalDateTimeDeserializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_DATE_TIME_FORMAT)));
        javaTimeModule.addDeserializer(LocalDate.class, new LocalDateDeserializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_DATE_FORMAT)));
        javaTimeModule.addDeserializer(LocalTime.class, new LocalTimeDeserializer(DateTimeFormatter.ofPattern(JacksonConfig.DEFAULT_TIME_FORMAT)));
